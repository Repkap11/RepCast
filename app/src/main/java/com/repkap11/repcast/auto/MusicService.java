...
package com.repkap11.repcast.auto;
...
import static com.repkap11.repcast.auto.MusicProvider.MEDIA_ID_EMPTY_ROOT;
import static com.repkap11.repcast.auto.MusicProvider.MEDIA_ID_ROOT;
...
public class MusicService extends MediaBrowserServiceCompat {
    ...
    public void onCreate() {
        ...
        Intent intent = new Intent(context, RepcastActivity.class);
    ...
    public BrowserRoot onGetRoot(@NonNull String clientPackageName,
        ...
        if (!clientPackageName.equals(getPackageName())) {
            ...
            Log.e(TAG, "Invalid package..." + clientPackageName + " " + getPackageName());
            //return new BrowserRoot(MEDIA_ID_EMPTY_ROOT, null);
        }
        Log.e(TAG, "Valid package..." + clientPackageName + " " + getPackageName());
